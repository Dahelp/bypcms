...
export function PublicHeader({ active = "" }: { active?: "services" | "modules" | "portfolio" | "order" | "" }) {
  return <header className="publicHeader">
    <div className="publicHeaderInner publicContainer">
      ...
      <nav aria-label="Основная навигация">
        ...
        <Link className={active === "portfolio" ? "active" : ""} href="/portfolio">Портфолио</Link>
...
export function PublicFooter() {
  return <footer className="publicFooter">
    <div className="publicFooterInner publicContainer">
      ...
      <nav aria-label="Разделы сайта"><Link href="/#products">Редакции</Link><Link href="/#builder">Калькулятор</Link><Link href="/portfolio">Портфолио</Link><Link href="/modules">Модули</Link><Link href="/services">Услуги</Link><a href={DEMO_URL}>Демо</a></nav>
