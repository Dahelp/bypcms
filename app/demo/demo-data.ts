...
export const moduleRegistry: DemoModule[] = [
  ...
  { key: "faq", name: "Вопросы и ответы", description: "FAQ-разделы, вопросы к товарам и услугам, микроразметка FAQPage.", version: "1.1.2", price: 5900, editions: ["content", "business", "commerce"], slots: ["menu.main", "editor.tab", "editor.sidebar", "dashboard.widget", "settings.section"], menu: { id: "faq", label: "Вопросы и ответы", icon: "?", group: "Контент", moduleKey: "faq" }, editorKinds: ["pages", "articles", "services", "products", "categories"], color: "#7a5a9c" },
];
