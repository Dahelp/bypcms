  ...
  return <main className="realDemo" style={{ "--demo-accent": theme.accent, "--demo-radius": `${theme.radius}px` } as React.CSSProperties}>
    ...
    <section className="realWorkspace">
      ...
      <div className="realContent">
        ...
        {view === "overview" && <Dashboard edition={edition} entities={entities} onNavigate={setView} />}
...
function Dashboard({ edition, entities, onNavigate }: { edition: EditionKey; entities: DemoEntity[]; onNavigate: (id: string) => void }) {
